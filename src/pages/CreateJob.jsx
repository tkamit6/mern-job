                ...
                <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
                    <div className='flex flex-col lg:flex-row items-center justify-between gap-8 '>
                        <div className='lg:w-1/2 w-full'>
                            ...
                            <input type="text" placeholder="Web Developer" {...register("jobTitle")} className='block w-full flex-1 border-1 bg-white py-1.5 pl-3 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6 focus:ring-2 ring-blue rounded-sm' />
                        </div>
                        <div className='lg:w-1/2 w-full'>
                    ...
                    <div className='w-full'>
                        ...
                        <input type="email" placeholder="Ex: mail@mail.com " value={userData ? userData.email : ''} {...register("postedBy")} className='block w-full flex-1 border-1 bg-white py-1.5 pl-3 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6 focus:ring-2 ring-blue rounded-sm' />
                    </div>
